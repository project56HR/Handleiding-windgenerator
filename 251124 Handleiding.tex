...
\begin{document}
	...
	\subsection{Terminal openen in de Raspberri PI}
	\begin{itemize}
		...
		\end{lstlisting}
		\item Stap 4: Vervolgens zal dit in het scherm staan van de terminal:
		\begin{lstlisting}
			project56@192.168.1.101 password:
		\end{lstlisting}
		Hier voer je in het wachtwoord: project56 (het wachtwoord dat je invoert wordt niet getoond in de terminal)
	\end{itemize}
	...
	\begin{itemize}
		...
		\end{lstlisting}
		Type vervolgens CTRL x in op het op te slaan. en druk dan op ENter
	...
	\\
	De kop van de windgenerator wordt op 4 punten aan de steigerbuis vastgeschroeft. Hier moeten 4 $... mm$ gaten voor worden geboord, die elk op 90 graden van elkaar in de buis moeten worden geboord.jven
